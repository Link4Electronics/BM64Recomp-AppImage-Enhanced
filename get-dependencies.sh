...
ZIP_LINK=$(wget -qO- https://api.github.com/repos/RevoSucks/BM64Recomp/releases \
      | sed 's/[()",{} ]/\n/g' | grep -o -m 1 "https.*BM64Recompiled.*$zip_arch.zip")
...
bsdtar -xvf ./BM64Recompiled.tar.gz -C ./AppDir/bin
